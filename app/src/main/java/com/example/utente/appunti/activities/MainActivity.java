package com.example.utente.appunti.activities;
...
import com.example.utente.appunti.R;
import com.example.utente.appunti.adapters.NoteCardAdapter;
//import com.example.utente.appunti.controllers.MyTouchHelper;
import com.example.utente.appunti.db.DBHandler;
import com.example.utente.appunti.model.Note;
import com.example.utente.appunti.model.State;
...
public class MainActivity extends AppCompatActivity implements TextWatcher {
    ...
    public int nricerche = 0;
    //gestione ordinamento
    public int getCurrentOrderType() {
        return currentOrderType;
    }
    public void setCurrentOrderType(int currentOrderType) {
        this.currentOrderType = currentOrderType;
    }
    private final int ORDER_ASC = 1;        //DEFAULT
    private final int ORDER_DESC = 2;
    private int currentOrderType = ORDER_ASC;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        //gestione search note
        searchEt = (EditText) findViewById(R.id.main_search_bar);
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        if(getCurrentOrderType() == ORDER_ASC)
            toolbar.getMenu().findItem(R.id.menu_sort).setIcon(R.drawable.ic_sort_descending_white_24dp);
        else if (getCurrentOrderType() == ORDER_DESC)
            toolbar.getMenu().findItem(R.id.menu_sort).setIcon(R.drawable.ic_sort_ascending_white_24dp);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id == R.id.menu_sort){
            if(getCurrentOrderType() == ORDER_ASC){
                ...
                setCurrentOrderType(ORDER_DESC);
                noteCardAdapter.sortDesc();
            }
            else {
                item.setIcon(R.drawable.ic_sort_ascending_white_24dp);
                item.setTitle("Descending");
                setCurrentOrderType(ORDER_ASC);
                noteCardAdapter.sortAsc();
            }
        ...
        if(id == R.id.menu_search){
            ...
            else searchEt.setVisibility(View.VISIBLE);
        }
    ...
    public void afterTextChanged(Editable s) {
         ...
         if(searchEt.getText().toString().isEmpty()) {
             ...
             searchEt.setVisibility(View.GONE);
             noteCardAdapter.restoreDataSet();
         }
         else noteCardAdapter.search(searchEt.getText().toString());
        nricerche++;
    }
}
