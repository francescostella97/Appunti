package com.example.utente.appunti.adapters;
...
import com.example.utente.appunti.activities.AddNoteActivity;
import com.example.utente.appunti.activities.MainActivity;
...
public class NoteCardAdapter extends RecyclerView.Adapter<NoteCardAdapter.NoteCardVH> {
    ...
    ArrayList<Note> restoredDataSet;
    public void restoreDataSet(){
        //risetta dataset senza filtri
        setDataSet(restoredDataSet);
    }
    public void saveDataSet(){
        //salva dataset corrente
        restoredDataSet = new ArrayList<>(dataSet);
    }
    public void search(String filter){
        filter = filter.toLowerCase();
        ArrayList<Note> filtered = new ArrayList<>();
        for (Note n : dataSet){
            if(n.getTitle().toLowerCase().contains(filter)){
                filtered.add(n);
            }
        }
        setDataSet(filtered);
    ...
    public void sortAsc(){
        Collections.sort(dataSet, new Comparator<Note>() {
            @Override
